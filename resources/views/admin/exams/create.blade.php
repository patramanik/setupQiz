...
<div class="mb-6 flex items-center justify-between">
    <div>
        ...
        <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Create New Exam</h2>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Add a new exam to the system. An exam code will be automatically generated.</p>
    </div>
</div>
