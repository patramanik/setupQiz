...
<div class="mb-6 flex items-center justify-between">
    <div>
        ...
        <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Create New Subject</h2>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Add a new subject and map it to an existing active exam.</p>
    </div>
</div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div class="md:col-span-2">
                ...
                <select name="exam_id" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-900/50 focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 text-gray-800 dark:text-gray-100 transition-colors" required>
                    <option value="" disabled selected>Select an active exam...</option>
                ...
                @if($exams->isEmpty())
                    <p class="text-[11px] text-rose-500 mt-2">
                        <i class="fas fa-exclamation-triangle mr-1"></i> You must have at least one active exam before creating a subject.
                    </p>
                @endif
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <div class="flex items-center gap-6">
                    ...
                    <label class="relative flex items-center gap-3 cursor-pointer group">
                        <input type="radio" name="is_active" value="1" class="peer sr-only" {{ old('is_active', '1') == '1' ? 'checked' : '' }} required>
                    ...
                    <!-- Inactive Option -->
                    <label class="relative flex items-center gap-3 cursor-pointer group">
                        <input type="radio" name="is_active" value="0" class="peer sr-only" {{ old('is_active') == '0' ? 'checked' : '' }} required>
